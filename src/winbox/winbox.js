...
(function(window){
    ...
    var module_wm = (function($){
        ...
        function WindowManager(tpl, settings){
            ...
            this.prefix = settings.prefix || '_wm_', this.suffix = settings.suffix || '_message_', this.width = settings.width, this.height = settings.height, this.top = settings.top, this.left = settings.left, this.needmask = settings.needmask || true, this.events = $.extend({}, {
                'click|.cancel': 'close',
                'click|.confirm': 'close'
            }, settings.events);
